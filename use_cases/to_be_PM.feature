Feature: Choose an employee to be a project manager
  ...
  Scenario: Choose an employee to be a project manager for a project whose deadline has passed
    Given the CEO provides the project id "2019000001" along with the project name "TestProject1" whose deadline has passed
    And the employee with the ID "abcd" exists
    When the CEO chooses an employee with an ID "abcd" to be a project manager for the project with the ID "2019000001"
    Then the system provides an error message "The deadline for this project has passed"
  ...
  Scenario: Choose an employee to be a project manager for non-existing project
    Given the CEO provides the project id "abcd" along with the project name "TestProject1"
    And the employee with the ID "abcd" exists
    When the CEO chooses an employee with an ID "abcd" to be a project manager for the project with the ID "2019000001"
    Then the system provides an error message "This project does not exist"
