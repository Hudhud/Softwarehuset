...
Scenario:
Employee enters an illegal value (a String) for working time for an activity 
...
Scenario:
Employee enters a value, which is equal to or less than 0.0 for working time for an activity 
	Given that the employee provides the activity with a name 
...
Scenario:
Employee wants to register working time for an activity with deadline exceeded 
	Given that the employee provides the activity with a name 
	And the employee provides his working time "2.0" hours 
